      ...
      <div class="site-content" style="padding-top: 0px;">
        ...
        <div class="panel panel-default m-b-0">
          <div class="panel-heading menu-bar-colr">
            <h3 class="m-y-0">Inventory Functions</h3>
          </div>
          <div class="panel-body">
            <!-- <pre><?php //echo print_r($outofStock) ?> </pre> -->
            <div class="row row-sm">
              <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 tab" id="tab1">
                <div class="demo-flag-block" onclick="chnage('available_inventory');" style="cursor: pointer;">
                  <div class="name" title="Afghanistan" style="font-size: 14px;">
                    <strong>
                      <span class="code">INV -</span>
                      <span class="func" id="func1">Avaiable</span> 
                    </strong>
                  </div>
                  <div class="capital" style="color: #666666;">Show room</div>
                  <span class="icn-stye"> 
              ...
              <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 tab" id="tab2">
                <div class="demo-flag-block" onclick="chnage('bank');" style="cursor: pointer;">
                  <div class="name" title="Afghanistan" style="font-size: 14px;">
                    <strong>
                      <span class="code">INV -</span>
                      <span class="func" id="func2">Available</span>
                    </strong>
                  </div>
                  <div class="capital" style="color: #666666;">Store</div>
                  <span class="icn-stye"> 
                    <i class="zmdi zmdi-store zmdi-hc-fw" style="color:#5296ce;"></i>
                  </span>
                </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 tab" id="tab3">
                <div class="demo-flag-block" onclick="chnage('bank');" style="cursor: pointer;">
                  <div class="name" title="Afghanistan" style="font-size: 14px;">
                    <strong>
                      <span class="code">INV -</span>
                      <span class="func" id="func3">Report</span>
                    </strong>
                  </div>
                  <div class="capital" style="color: #666666;">Manage</div>
                  <span class="icn-stye"> 
                    <i class="zmdi zmdi-collection-text zmdi-hc-fw" style="color:#5296ce;"></i>
                  </span>
                </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 tab" id="tab4">
                <div class="demo-flag-block" onclick="chnage('manage_inventory');" style="cursor: pointer;">
                  <div class="name" title="Afghanistan" style="font-size: 14px;">
                    <strong>
                      <span class="code">INV -</span>
                      <span class="func" id="func4">Manage</span>
                    </strong>
                  </div>
                  <div class="capital" style="color: #666666;">Manage</div>
                  <span class="icn-stye"> 
                    <i class="zmdi zmdi-settings-square zmdi-hc-fw" style="color:#5296ce;"></i>
                  </span>
                </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2" id="tab5">
                <div class="demo-flag-block" onclick="chnage('create_inventory');" style="cursor: pointer;">
                  <div class="name" title="Afghanistan" style="font-size: 14px;">
                    <strong>
                      <span class="code">INV -</span>
                      <span class="func" id="func5">Create</span>
                    </strong>
                  </div>
                  <div class="capital" style="color: #666666;">Manage</div>
                  <span class="icn-stye"> 
                    <i class="zmdi zmdi-open-in-browser zmdi-hc-fw" style="color:#5296ce;"></i>
                  </span>
                </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2" id="tab6">
                <div class="demo-flag-block" onclick="chnage('OOS');" style="cursor: pointer;">
                  <div class="name" title="Afghanistan" style="font-size: 14px;">
                    <strong>
                      <span class="code">INV -</span>
                      <span class="func" id="func6">Out of Stock</span>
                    </strong>
                  </div>
                  <div class="capital" style="color: #666666;">Manage</div>
                  <span class="icn-stye"> 
                    <i class="zmdi zmdi-alert-circle zmdi-hc-fw" style="color:#5296ce;"></i>
                  </span>
                </div>
              </div>
            </div>
