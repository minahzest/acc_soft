...
<body class="layout layout-header-fixed layout-left-sidebar-fixed layout-desktop layout-left-sidebar-collapsed">
  ...
  <div class="site-main">
    ...
    <div class="site-content" style="padding-top: 0px;">
      ...
      <div class="panel panel-default panel-table" id="panel-1">
        <div class="panel-heading">
          <h3 class="m-t-0 m-b-5" style="float: left;">Payments</h3>
          <div class="text-right dark-font" style="font-size: 20px;">
            <button type="button" class="btn btn-outline-theme m-w-120 pull-righ" onclick="addPay()">
          ...
          <div class="table-responsive">
            <table class="table table-striped dataTable" id="table-2">
              ...
              <tbody id="table_body">
                ...
                ?>
                  <tr id="tb<?= $val->pay_id ?>" style="<?= $labelCol ?>">
                    <td id="name<?= $val->pay_id ?>">
                    ...
                    <td><?= $val->paid_on ?></td>
                    <td class="text-right">
                      <button type="button" class="btn btn-outline-theme pull-righ" onclick="editPay(<?= $val->pay_id ?>, '<?= $val->supplier_name ?>',<?= $val->supplier_id ?>,'<?= $val->descrip ?>')">
                        <i class="zmdi zmdi-edit zmdi-hc-fw"></i>
                      </button>
                      <button type="button" class="btn btn-outline-danger pull-righ" onclick="deletePay(<?= $val->pay_id ?>)">
      ...
      <div class="panel panel-default panel-table" id="panel-2" style="display: none;">
        <div class="panel-heading">
          <h3 class="m-t-0 m-b-5" style="float: left;">Make a payment</h3>
          <div class="text-right dark-font" style="font-size: 20px;">
            <button type="button" class="btn btn-outline-theme m-w-120 pull-righ" onclick="closePay()">
  ...
  <script type="text/javascript">
    ...
    function editPay(id, name, supplier, desc) {
  ...
  <script>
    $('#pay_form').on('submit', function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?= base_url() ?>save_payment_ajax',
